...
if (isset($_POST['first_name']) && isset($_POST['middle_name']) && isset($_POST['last_name']) && isset($_POST['uname']) 
    ...
    if(empty($first_name)){
        ...
        if (mysqli_num_rows($result) > 0){
            ...
            if($result2){
                ...
                header("Location: signup.php?error=Unknown error occured. Try again.");
                exit();
            }
        }
    }
